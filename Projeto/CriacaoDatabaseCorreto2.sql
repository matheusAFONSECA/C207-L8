...
-- -----------------------------------------------------
-- Table `mydb`.`Nota_has_Materia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Nota_has_Materia` (
  `Nota_idNotas` INT NOT NULL,
  `Materia_idMateria` VARCHAR(5) NOT NULL,
  `Materia_Professor_idProfessor` INT NOT NULL,
  PRIMARY KEY (`Nota_idNotas`, `Materia_idMateria`, `Materia_Professor_idProfessor`),
  INDEX `fk_Nota_has_Materia_Materia1_idx` (`Materia_idMateria` ASC, `Materia_Professor_idProfessor` ASC) VISIBLE,
  INDEX `fk_Nota_has_Materia_Nota1_idx` (`Nota_idNotas` ASC) VISIBLE,
  CONSTRAINT `fk_Nota_has_Materia_Nota1`
    FOREIGN KEY (`Nota_idNotas`)
    REFERENCES `mydb`.`Nota` (`idNotas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Nota_has_Materia_Materia1`
    FOREIGN KEY (`Materia_idMateria` , `Materia_Professor_idProfessor`)
    REFERENCES `mydb`.`Materia` (`idMateria` , `Professor_idProfessor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
