...
CREATE TABLE IF NOT EXISTS `mydb`.`Estrela` (
  ...
  `nomeGalaxia` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Nave` (
  `idNave` INT NOT NULL,
  `nome` VARCHAR(45) NOT NULL,
  `quantidadeTripulantes` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Viagem` (
  ...
  PRIMARY KEY (`Planeta_idPlaneta`, `Planeta_Estrela_idEstrela`, `Nave_idNave`, `Mapa_idMapa`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tripulante` (
  ...
  `Nave_idNave` INT NOT NULL,
  PRIMARY KEY (`idTripulante`, `Nave_idNave`),
